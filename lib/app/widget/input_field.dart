...
import 'package:messaging/app/widget/note_text.dart';
...
class InputField extends StatefulWidget {
  const InputField({
    ...
    this.height,
    this.onSubmitted,
    this.validationColor = AppColors.primaryTextColor,
    Key? key,
  }) : super(key: key);
        ...
        Container(
          ...
          decoration: BoxDecoration(
            border: widget.noBorder
                ? null
                : Border.all(color: widget.validationColor),
              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: TextStyle(
                      fontSize: widget.smallVersion ? 15 : 15,
