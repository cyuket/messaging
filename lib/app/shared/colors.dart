...
class AppColors {
  // Blue
  static const blueColor = Color(0xff0061FF);
  ...
  // Yellow
// text
  static const primaryTextColor = Color(0xff323B4B);
  static final secondaryTextColor = const Color(0xff000000).withOpacity(0.5);
  static const secondaryTextColor2 = Color(0xff8A94A6);
  // Black
